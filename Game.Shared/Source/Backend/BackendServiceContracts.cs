...
namespace Game.Shared.Backend
{
    ...
    public sealed class BackendAccountRequest
    {
        ...
        // Random per-install identifier generated by the client. The backend stores only
        // a keyed hash and never raw hardware identifiers.
    ...
    public sealed class BackendAuthResponse
    {
        ...
        [DataMember(Name = "policy")] public AccountPolicySnapshot policy;
    }
